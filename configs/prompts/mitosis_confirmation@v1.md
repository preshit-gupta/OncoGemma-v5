...
1. Context Image: 512x512 um surrounding tumor bed architecture (10x magnification).
2. High-Power Focus Crop: 32x32 um centered on the candidate figure (40x magnification, ~0.25 um/pixel), marked with a subtle boundary circle.
...
4. Lymphocyte Exclusion: Mature lymphocytes display small (5-7 um), smooth, continuous round envelopes with coarse resting chromatin, without cytoplasmic spiculation.
